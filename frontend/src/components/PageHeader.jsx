...
const PageHeader = ({
  ...
  const hasMetric = Boolean(metricLabel);
  const hasFilters = Boolean(filters);
  const toolbarClassName = [
    "page-header__toolbar",
    hasMetric && hasFilters ? "page-header__toolbar--split" : "",
    hasFilters && !hasMetric ? "page-header__toolbar--filters-only" : "",
    hasMetric && !hasFilters ? "page-header__toolbar--metric-only" : "",
  ]
    .filter(Boolean)
    .join(" ");
